...
const char* ssid     = "golang";
const char* password = "MaliMedo1234";

// Use your own API key by signing up for a free developer account at https://openweathermap.org/
String apikey       = "a1bb50f3aba5c99692119c9f62cc11e8";                      // See: https://openweathermap.org/
...
String City             = "VIENNA";                      // Your home city See: http://bulk.openweathermap.org/sample/
String Country          = "AT";                            // Your _ISO-3166-1_two-letter_country_code country code, on OWM find your nearest city and the country code is displayed
